...
st.set_page_config(page_title="Painel Técnico – Setor 1", layout="wide")
...
# Mostra o valor com o label apropriado (Faltam ou Excesso)
col3.metric(label_faltam, faltam_mensal)

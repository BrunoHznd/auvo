...
<div class="mensal-card">
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
        <div style="text-align: center; flex: 1;">
            <div style="font-size: 0.9em;" class="adaptive-text">📋 Total Equipamentos</div>
            <div style="font-size: 1.5em; font-weight: bold;" class="adaptive-text">{qtde_equipamentos_setor}</div>
        </div>
        <div style="text-align: center; flex: 1;">
...
<div class="semestral-card">
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
        <div style="text-align: center; flex: 1;">
            <div style="font-size: 0.9em;" class="adaptive-text">📋 Total Previsto</div>

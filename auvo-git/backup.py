...
# Toda semestral conta como uma mensal, então precisamos somar os equipamentos únicos da mensal e da semestral
ids_equipamentos_mensal = ids_equipamentos_realizados
# ids_equipamentos_semestral será calculado abaixo
mensal_total_realizados = len(ids_equipamentos_mensal | ids_equipamentos_semestral)
faltam_semestral = max(semestral_previsto - semestral_realizados, 0)
col1, col2, col3 = st.columns(3)
col1.metric("📋 Total Equipamentos", qtde_equipamentos_setor)
col2.metric("✅ Prev. Mensal Realizada", mensal_realizados)
col3.metric("⚠️ Faltam Prev. Mensal", faltam_semestral)
...
col4.metric("📋 Total Previsto (Semestral)", semestral_previsto)
col5.metric("✅ Prev. Semestral Realizada", semestral_realizados)
col6.metric("⚠️ Faltam Prev. Semestral", max(semestral_previsto - semestral_realizados, 0))
